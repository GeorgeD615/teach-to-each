...
namespace TeachToEach.DAL.Configurations
{
    public class HomeworkConfiguration : IEntityTypeConfiguration<Homework>
    {
        public void Configure(EntityTypeBuilder<Homework> builder)
        {
            ...
            builder.Property(h => h.deadline).HasColumnName("deadline").IsRequired().HasColumnType("timestamp without time zone");
            builder.Property(h => h.solution_time).HasColumnName("solution_time").IsRequired().HasColumnType("timestamp without time zone");
